...
/////// Diffuse:
                ...
                float2 node_8590 = float2(sceneUVs.r,(1.0 - sceneUVs.g));
                float4 _ReflectionTex_var = tex2D(_ReflectionTex,TRANSFORM_TEX(node_8590, _ReflectionTex));
                float node_2654 = 1.0;
                float CubemapActive = _EnableCubemap;
                float3 node_4077 = (_Color.rgb*_ReflectionTex_var.rgb*lerp(float3(node_2654,node_2654,node_2654),(_ReflectionTex_var.a+saturate(((1.0 - _ReflectionTex_var.a)*CubemapSpec))),CubemapActive));
