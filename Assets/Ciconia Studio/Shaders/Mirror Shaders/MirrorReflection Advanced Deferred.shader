...
Shader "Ciconia Studio/Effects/MirrorReflection/Deferred rendering/Advanced" {
    Properties {
...
////// Specular:
                ...
                float3 Albedo = saturate(( lerp(saturate((_MirrorTintWhite.rgb*node_5069)),saturate((_MirrorTintBlack.rgb*node_5069)),saturate((1.0 - RedMask))) > 0.5 ? (1.0-(1.0-2.0*(lerp(saturate((_MirrorTintWhite.rgb*node_5069)),saturate((_MirrorTintBlack.rgb*node_5069)),saturate((1.0 - RedMask)))-0.5))*(1.0-saturate((1.0-(1.0-(((_ReflectionTex_var.rgb*lerp(float3(node_2502,node_2502,node_2502),(_ReflectionTex_var.a+saturate(((1.0 - _ReflectionTex_var.a)*CubemapSpec))),CubemapActive))*_ReflectionIntensity)*(ReflMask*(1.0 - (saturate((node_629+node_629))*BrokenControle)))))*(1.0-lerp(float3(node_8405,node_8405,node_8405),(((_BrokenColor.rgb*_BrokenmapBW_var.rgb*_BrokenmapBW_var.rgb*_BrokenmapBW_var.rgb)*_BrokenmapIntensity)*saturate((CubeMask+_TextureBlend))),BrokenControle)))))) : (2.0*lerp(saturate((_MirrorTintWhite.rgb*node_5069)),saturate((_MirrorTintBlack.rgb*node_5069)),saturate((1.0 - RedMask)))*saturate((1.0-(1.0-(((_ReflectionTex_var.rgb*lerp(float3(node_2502,node_2502,node_2502),(_ReflectionTex_var.a+saturate(((1.0 - _ReflectionTex_var.a)*CubemapSpec))),CubemapActive))*_ReflectionIntensity)*(ReflMask*(1.0 - (saturate((node_629+node_629))*BrokenControle)))))*(1.0-lerp(float3(node_8405,node_8405,node_8405),(((_BrokenColor.rgb*_BrokenmapBW_var.rgb*_BrokenmapBW_var.rgb*_BrokenmapBW_var.rgb)*_BrokenmapIntensity)*saturate((CubeMask+_TextureBlend))),BrokenControle))))) ));
