...
Shader "Ciconia Studio/Effects/MirrorReflection/Deferred rendering/Fast Window" {
    Properties {
...
/////// Diffuse:
                ...
                float3 node_1896 = lerp(float3(node_8030,node_8030,node_8030),(_ReflectionTex_var.a+saturate(((1.0 - _ReflectionTex_var.a)*CubemapSpec))),CubemapActive);
                float3 node_1109 = (lerp(_Color.rgb,_DirtTint.rgb,node_3386)*_ReflectionTex_var.rgb*node_1896);
