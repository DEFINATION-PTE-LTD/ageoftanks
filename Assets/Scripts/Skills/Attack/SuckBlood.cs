...
/// <summary>
/// 攻击技能-吸血
/// 对目标造成伤害并回复自身一定的血量（20%-200%）
/// </summary>

public class SuckBlood : MonoBehaviour
{
    public float Value = 0;//百分比几率
    ...
    {
        //挂载后的默认状态
        SkillPrefab = CommonHelper.GetPrefabs("skill", "Attack/吸血");
    ...
    public bool EffectAttack()
    {
        ...
        GameObject child = SkillEffect.transform.Find("42_RFX_Blood_Puddle1").gameObject;
