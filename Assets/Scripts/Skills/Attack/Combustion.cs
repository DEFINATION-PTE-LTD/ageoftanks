...
/// <summary>
/// 攻击技能-燃烧
/// 每回合造成最大生命值百分比的伤害（5%-50%）
/// </summary>
public class Combustion : MonoBehaviour
{
    public float Value = 0;//百分比伤害
    ...
    {
        //挂载后的默认状态
        SkillPrefab = CommonHelper.GetPrefabs("skill", "Attack/燃烧");
    ...
    public bool EffectAttack()
    {
        ...
        GameObject child = SkillEffect.transform.Find("22_RFX_Fire_Campfire1").gameObject;
