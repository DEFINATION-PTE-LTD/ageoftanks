...
/// 一击必杀目标（概率10%-50%）
/// </summary>
public class Hatchshot : MonoBehaviour
{
    ...
    {
        //挂载后的默认状态
        SkillPrefab = CommonHelper.GetPrefabs("skill", "Attack/必杀");
    ...
    public bool EffectAttack()
    {
        ...
        GameObject child = SkillEffect.transform.Find("55_RFX_Shock_Bomb1").gameObject;
