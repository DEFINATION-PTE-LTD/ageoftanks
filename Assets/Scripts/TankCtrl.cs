...
public class TankCtrl : MonoBehaviour
{
    ...
    void KeyListener()
    {
        ...
        #region 蝎式坦克键盘监听
        if (animator.name == "Legs_Spider_Hvy" || animator.name == "Legs_Spider_Lt_Ctrl" || animator.name == "Legs_Spider_Med_Ctrl")
        {
            //上箭头-前进
            if (v > 0)
            {
        ...
        #region 短履带坦克键盘监听
        else if (animator.name == "Legs_Tracks_Lvl0_Ctrl" || animator.name == "Legs_Tracks_Lvl1_Ctrl" || animator.name == "Legs_Tracks_Lvl2_Ctrl" || animator.name == "Legs_Tracks_Lvl3_Ctrl")
        {
